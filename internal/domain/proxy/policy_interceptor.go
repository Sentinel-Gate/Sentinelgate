...
// ErrQuotaExceeded indicates a tool call was denied due to quota limits.
// Defined in the proxy package to avoid import cycles between proxy and quota.
var ErrQuotaExceeded = errors.New("quota exceeded")

// ErrContentBlocked indicates input content scanning blocked the request.
// Defined here to avoid import cycles between proxy and action packages.
var ErrContentBlocked = errors.New("request blocked by content scanning: sensitive data detected in arguments")

// ErrResponseBlocked indicates response content scanning blocked the response.
var ErrResponseBlocked = errors.New("response blocked by content scanning")

// ErrOutboundBlocked indicates an outbound rule blocked the request.
var ErrOutboundBlocked = errors.New("outbound blocked")
