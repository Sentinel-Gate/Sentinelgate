...
const (
	...
	// ActionProtocol represents MCP protocol methods (initialize, ping, tools/list,
	// notifications/*, etc.) that are NOT subject to policy evaluation.
	ActionProtocol ActionType = "protocol"
)
