...
// underscores, hyphens, and dots. Dots are allowed for MCP namespaced tool names
// (e.g. "namespace.toolName"). Path traversal via ".." is caught separately.
