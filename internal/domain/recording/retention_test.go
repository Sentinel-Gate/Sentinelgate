...
func TestRetentionCleaner_DeletesOldFiles(t *testing.T) {
	...
	// Create 3 JSONL files: 2 old (40 days), 1 new (5 days).
	old1 := touchFile(t, dir, "sess-old1_20260101T120000Z.jsonl")
	old2 := touchFile(t, dir, "sess-old2_20260101T120001Z.jsonl")
	newFile := touchFile(t, dir, "sess-new_20260214T120000Z.jsonl")
