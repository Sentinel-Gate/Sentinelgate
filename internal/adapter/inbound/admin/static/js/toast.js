...
SG.toast = {
  ...
  show: function (message, type) {
    ...
    if (SG.sounds && SG.sounds.isEnabled()) {
      if (type === 'error')   SG.sounds.alert();
      if (type === 'success') SG.sounds.confirm();
    }

    // ── Auto-dismiss progress bar ──────────────────────────────────
    var progressBar = document.createElement('div');
    progressBar.className = 'toast-progress';
    progressBar.style.animationDuration = this.AUTO_DISMISS_MS + 'ms';
