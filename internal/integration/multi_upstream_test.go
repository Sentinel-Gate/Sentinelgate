...
func (m *intMockMCPClient) Start(_ context.Context) (io.WriteCloser, io.ReadCloser, error) {
	...
	// Use pipes with an auto-responder for init handshake.
	...
	m.pipeCleanup = func() { reqReader.Close() }
...
func (m *intMockConnectionProvider) GetConnection(upstreamID string) (io.WriteCloser, <-chan []byte, error) {
