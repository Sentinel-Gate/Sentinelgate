...
func TestRegression_MultipleToolCallsSequence(t *testing.T) {
	...
	upstream := &mockUpstreamRouter{
		toolCallResponse: buildRegressionUpstreamResponse("result"),
	}
	...
	msg1 := buildRegressionMessage("tools/call", 1, map[string]interface{}{
		"name":      "read_file",
	...
	msg2 := buildRegressionMessage("tools/call", 2, map[string]interface{}{
		"name":      "exec_command",
	...
	msg3 := buildRegressionMessage("tools/call", 3, map[string]interface{}{
		"name":      "list_files",
...
func TestRegression_UnknownMethodPassthrough(t *testing.T) {
	...
	upstreamRouter := &mockUpstreamRouter{
		toolCallResponse: buildRegressionUpstreamResponse("pong"),
	}
	...
	msg := buildRegressionMessage("custom/ping", 42, map[string]interface{}{
		"data": "hello",
	}, sess)
...
func (m *regressionAdminAuditReader) Query(filter audit.AuditFilter) ([]audit.AuditRecord, string, error) {
